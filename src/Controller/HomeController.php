...
class HomeController extends AbstractController
{
    ...
    public function home()
    {
        ...
        // Je crée une variable 'lastArticles' qui intègre les 3 derniers articles
        // Les 3 derniers articles sont récupérés à partir d'un slice du tableau commençant à l'élément 1
        $lastArticles = array_slice($articles, 1);

        return $this->render('home.html.twig', ['articles'=>$lastArticles]);
    }
